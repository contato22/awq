        ...
        sections: [
            {
                ...
                items: [
                    ...
                    { label: "AR Aging",               href: "/awq/epm/ar/aging",            icon: Receipt       },
                    { label: "Cobrança (AR)",          href: "/awq/epm/ar/collections",      icon: Zap           },
            ...
            },
            {
                ...
                items: [
                    { label: "Budget",             href: "/awq/budget",                icon: BarChart3  },
                    { label: "Budget vs Actual",   href: "/awq/epm/budget",            icon: Target     },
                    { label: "Budget Aprovação",   href: "/awq/epm/budget/approval",   icon: CheckCircle2},
                    { label: "Forecast",           href: "/awq/forecast",              icon: TrendingUp },
                    { label: "Forecast EPM",       href: "/awq/epm/forecast",          icon: TrendingUp },
                    { label: "Períodos",           href: "/awq/epm/periods",           icon: Calendar   },
                    { label: "Centros de Custo",   href: "/awq/epm/cost-centers",      icon: LayoutGrid },
                ],
            },
            {
...
const JACQES_MODULES: BUModule[] = [
    {
        ...
        icon: DollarSign,
        items: [
            { label: "Financial",      href: "/jacqes/financial", icon: LineChart  },
            { label: "FP&A",           href: "/jacqes/fpa",       icon: BarChart3  },
            { label: "Budget",         href: "/jacqes/budget",    icon: Target     },
            { label: "Mini P&L",       href: "/jacqes/pl",        icon: Scale      },
    ...
    },
    {
        ...
        icon: Users,
        items: [
            { label: "Dashboard CRM",  href: "/jacqes/crm",               icon: Target       },
            ...
            { label: "Expansão",       href: "/jacqes/crm/expansao",      icon: TrendingUp   },
            { label: "Health Score",   href: "/jacqes/crm/health",        icon: HeartPulse   },
            { label: "Propostas",      href: "/jacqes/crm/propostas",     icon: FileText     },
            { label: "Tarefas",        href: "/jacqes/crm/tarefas",       icon: ClipboardList},
            { label: "Interações",     href: "/jacqes/crm/interacoes",    icon: MessageSquare},
            { label: "Relatórios",     href: "/jacqes/crm/relatorios",    icon: BarChart3    },
        ],
    },
    {
        id: "ops",
        ...
        items: [
            ...
            { label: "SGA",           href: "/jacqes/sga",      icon: ShieldCheck},
            { label: "Carteira",      href: "/jacqes/carteira", icon: Wallet     },
...
const CAZA_MODULES: BUModule[] = [
    ...
    },
    {
        ...
        items: [
            { label: "Clientes",       href: "/caza-vision/clientes",          icon: Users        },
            { label: "Dashboard CRM",  href: "/caza-vision/crm",               icon: Target       },
            { label: "Leads",          href: "/caza-vision/crm/leads",         icon: UserPlus     },
            { label: "Pipeline",       href: "/caza-vision/crm/pipeline",      icon: Activity     },
            { label: "Oportunidades",  href: "/caza-vision/crm/oportunidades", icon: ArrowUpRight },
...
const ADVISOR_MODULES: BUModule[] = [
    ...
    },
    {
        ...
        icon: Users,
        items: [
            { label: "Dashboard CRM", href: "/advisor/crm",       icon: Target },
            { label: "Customers",     href: "/advisor/customers", icon: Users  },
        ],
    },
];
