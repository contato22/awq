...
const ACCOUNTS: Account[] = [
  ...
  },
  {
    ...
    color: {
      ...
      badgeText:    "text-white",
      balanceBg:    "bg-violet-50",
      balanceBorder:"border-violet-100",
      balanceLabel: "text-violet-700",
      balanceValue: "text-violet-900",
      dot:          "bg-violet-500",
      syncBtn:      "border-violet-200 bg-violet-50 text-violet-700",
      syncBtnHover: "hover:bg-violet-100",
    },
  },
];
