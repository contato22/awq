    ...
    <div className="card p-4 lg:p-6">
      <div className="flex items-center justify-between mb-4 lg:mb-5">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5 font-medium">Revenue by product line</p>
        </div>
      ...
      <div className="hidden lg:block">
        <div className="grid grid-cols-[1fr_auto_auto_auto_auto] gap-x-4 px-3 py-2 text-xs font-semibold text-gray-400 uppercase tracking-[0.06em] border-b border-gray-200">
          <span>Product</span>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-6 h-6 rounded-md bg-gray-50 border border-gray-200 flex items-center justify-center text-xs font-bold text-gray-400 shrink-0">
                  {idx + 1}
                </div>
              ...
              <div className="flex justify-end">
                <span className={`badge text-xs ${status.classes}`}>{status.label}</span>
              </div>
            </div>
          );
        })}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className={`badge text-xs shrink-0 ${status.classes}`}>{status.label}</span>
                </div>
