...
const EPM_MODULES: ModuleCard[] = [
  { label: "P&L (DRE)",          sub: "Demonstração de Resultado",    href: "/epm/pl",             icon: LineChart,     color: "text-emerald-600", bg: "bg-emerald-50",  status: "active" },
  { label: "Balanço Patrimonial", sub: "Activo = Passivo + PL",        href: "/epm/balance-sheet",  icon: Scale,         color: "text-brand-600",   bg: "bg-brand-50",    status: "active" },
  { label: "Budget vs Actual",    sub: "Variance analysis",            href: "/epm/budget",         icon: Target,        color: "text-violet-600",  bg: "bg-violet-50",   status: "active" },
  { label: "KPI Dashboard",       sub: "MRR, EBITDA, Runway…",         href: "/epm/kpis",           icon: PieChart,      color: "text-cyan-700",    bg: "bg-cyan-50",     status: "active" },
  { label: "Contas a Pagar",      sub: "AP · Aging · DPO",             href: "/epm/ap",             icon: ArrowDownLeft, color: "text-red-600",     bg: "bg-red-50",      status: "active" },
  { label: "Contas a Receber",    sub: "AR · Aging · DSO",             href: "/epm/ar",             icon: ArrowUpRight,  color: "text-emerald-600", bg: "bg-emerald-50",  status: "active" },
  { label: "Razão Geral (GL)",    sub: "Lançamentos contábeis",        href: "/epm/gl",             icon: ListOrdered,   color: "text-amber-700",   bg: "bg-amber-50",    status: "active" },
  { label: "Consolidação",        sub: "Multi-entidade · Holding",     href: "/epm/consolidation",  icon: Building2,     color: "text-violet-600",  bg: "bg-violet-50",   status: "active" },
];
    ...
    <>
      ...
      <div className="page-container">
        ...
        <div className={`flex items-center gap-2 px-4 py-3 rounded-xl text-xs font-medium border ${
          ...
          {!dre.hasData && (
            <Link href="/conciliacao" className="underline font-semibold">
              /awq/conciliacao
            </Link>
          )}
          {glCount > 0 && (
        ...
        {balanceSheet.hasData && (
          <section className="card p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/epm/balance-sheet" className="text-xs text-brand-600 hover:underline font-medium">
                Ver completo →
              </Link>
            </div>
        ...
        <section className="card p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/epm/budget" className="text-xs text-brand-600 hover:underline font-medium">
              Detalhar →
            </Link>
          </div>
        ...
        <section className="card p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-3">
              <Link href="/epm/gl/add" className="text-xs px-3 py-1.5 bg-brand-600 text-white rounded-lg hover:bg-brand-700 font-semibold transition-colors">
                + Lançamento
              </Link>
              <Link href="/epm/gl" className="text-xs text-brand-600 hover:underline font-medium">
                Ver razão →
              </Link>
            </div>
          </div>
