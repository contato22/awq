  ...
  return (
    <div className="card p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/epm/budget" className="text-xs text-brand-600 hover:underline">Detalhes →</Link>
      </div>
    ...
    <>
      ...
      <div className="page-container">
        ...
        {dre.hasData && dre.ambiguousCount > 0 && (
          <div className="card p-4 border-l-4 border-amber-400">
            ...
            <p className="text-xs text-amber-700">
              ...
              <Link href="/conciliacao" className="underline font-medium">Conciliação</Link>.
            </p>
          </div>
        )}
        ...
        <div className="flex items-center gap-3 text-xs">
          <Link href="/epm" className="flex items-center gap-1 text-brand-600 hover:underline">
            ← EPM Overview
          </Link>
          <span className="text-gray-300">|</span>
          <Link href="/epm/balance-sheet" className="flex items-center gap-1 text-brand-600 hover:underline">
            Balanço Patrimonial <ChevronRight size={11} />
          </Link>
          <Link href="/epm/budget" className="flex items-center gap-1 text-brand-600 hover:underline">
