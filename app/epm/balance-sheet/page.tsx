        ...
        <div className="page-container">
          <div className="card p-16 flex flex-col items-center gap-4 text-center">
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              <Link href="/epm" className="text-xs text-brand-600 hover:underline">
                ← EPM Overview
              </Link>
            </div>
          </div>
    ...
    <>
      ...
      <div className="page-container">
        ...
        <div className="flex items-center gap-3 text-xs">
          ...
          <Link href="/epm/gl" className="text-brand-600 hover:underline">Ver lançamentos GL →</Link>
          <Link href="/epm/gl/add" className="text-brand-600 hover:underline">+ Novo lançamento →</Link>
        </div>
