    ...
    <>
      ...
      <div className="page-container">
        ...
        <div className="flex flex-wrap items-center gap-4 text-[11px] text-gray-500 px-1">
          ...
          <Link href="/management" className="ml-auto text-[10px] text-brand-500 hover:text-brand-400 flex items-center gap-0.5">
        ...
        <div className="card p-5">
          ...
          <div className="mt-3 flex gap-3">
            <Link href="/cashflow" className="text-[11px] text-brand-600 hover:text-brand-500 flex items-center gap-1">
              <ChevronRight size={11} /> Ver Cash Flow completo
            </Link>
            <Link href="/financial" className="text-[11px] text-brand-600 hover:text-brand-500 flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
          {[
            { label: "Financial (Real)",  href: "/financial",    icon: DollarSign, color: "text-emerald-600", bg: "bg-emerald-50" },
            { label: "Cash Flow (Real)",  href: "/cashflow",     icon: Zap,        color: "text-brand-600",   bg: "bg-brand-50"   },
            { label: "Gestão de Base",    href: "/management",   icon: Target,     color: "text-violet-700",  bg: "bg-violet-50"  },
          ].map((item) => {
