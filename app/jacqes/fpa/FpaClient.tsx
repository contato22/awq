...
// (REAL_BY_MI, dreRows, mrrHistory etc. are derived inside the component from props)
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function FpaClient({ buData, monthlyRevenue, jacqesMRR }: FpaClientProps) {
  const JACQES_MRR = jacqesMRR;
  const _jacqes = buData.find((b) => b.id === "jacqes")!;

  // ─── DRE rows (derived from props) ──────────────────────────────────────────
