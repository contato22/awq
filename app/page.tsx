      ...
      <div className="page-container">
        ...
        <section className="card p-5 lg:p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            />
            <Link href="/conciliacao" className="text-xs text-brand-600 hover:underline font-medium">
              Ingerir extratos →
            </Link>
          </div>
        ...
        <section>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              { label: "EPM",          sub: "P&L · Budget · KPIs · GL",  href: "/epm",         icon: Layers,        color: "text-brand-600",   bg: "bg-brand-50"   },
              { label: "Financial",    sub: "Visão de caixa",            href: "/financial",   icon: DollarSign,    color: "text-emerald-600", bg: "bg-emerald-50" },
              { label: "Cash Flow",    sub: "Fluxo de caixa",            href: "/cashflow",    icon: Zap,           color: "text-cyan-700",    bg: "bg-cyan-50"    },
              { label: "Investimentos",sub: "Aplicações / resgates",     href: "/investments", icon: Target,        color: "text-violet-600",  bg: "bg-violet-50"  },
              { label: "Ingestão",     sub: "Importar extratos PDF",      href: "/conciliacao",      icon: Database,      color: "text-brand-600",   bg: "bg-brand-50"   },
              { label: "Base de Dados",sub: "Gestão da camada de dados",  href: "/data",        icon: CheckCircle,   color: "text-emerald-600", bg: "bg-emerald-50" },
              { label: "Budget",       sub: "Budget vs Actual",          href: "/budget",      icon: Scale,         color: "text-violet-600",  bg: "bg-violet-50"  },
              { label: "Forecast",     sub: "Cenários 2026",             href: "/forecast",    icon: TrendingUp,    color: "text-amber-700",   bg: "bg-amber-50"   },
              { label: "Risk",         sub: "Risk signals",              href: "/risk",        icon: AlertTriangle, color: "text-red-500",     bg: "bg-red-50"     },
            ].map((item) => {
