      ...
      <div className="p-6 space-y-8">
        ...
        <section className="rounded-xl border border-gray-200 bg-white p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3">
            {[
              { href: "/cashflow",  icon: Zap,      label: "DFC — Fluxo de Caixa",  sub: "/cashflow"  },
              { href: "/financial", icon: LineChart, label: "DRE — Financeiro",       sub: "/financial" },
              { href: "/kpis",      icon: BarChart3, label: "KPIs Consolidados",      sub: "/kpis"      },
            ].map((item) => (
              <Link
                key={item.href}
                href={item.href}
