...
const FILE_HASH = "seed-btg-awq-208-50-019228733-2026-05-01-2026-06-03";
...
const RAW: RawTxn[] = [
  { date: "2026-05-26", desc: "Pix recebido de AWQ PRODUCOES LTDA · Banco 341 · CNPJ 44.859.574/0001-95", amount: 500.00 },
  { date: "2026-05-26", desc: "Débito na Conta Corrente",                                                  amount: -500.00 },
  { date: "2026-05-26", desc: "Aplicação Conta Remunerada",                                                amount: 500.00 },
...
async function runSeed(uploadedBy: string) {
  ...
  const doc: FinancialDocument = {
    ...
    extractionNotes:  "Seed manual a partir do PDF BTG Empresas AWQ Holding (Banco 208 / Ag 50 / Conta 019228733). Hand-extracted by /api/setup/seed-btg-extract.",
    blobUrl:          null,
  };
