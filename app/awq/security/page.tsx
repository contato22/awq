  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-xs text-blue-600 mt-1">Compliance (LGPD, políticas, aceites) → <a href="/awq/compliance" className="underline">/awq/compliance</a></p>
      </div>
...
function ActionBadge({ action }: { action: SecurityAction; [extra: string]: unknown }) {
