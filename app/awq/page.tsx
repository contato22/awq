                ...
                <div className="px-8 py-6 space-y-6">
                  {/* Group KPIs */}
                        ...
                        return (
                                        <div key={kpi.label} className="card p-5 flex items-start gap-4">
                                                        ...
                                                        <div>
                                                                          <div className="text-2xl font-bold text-white">{kpi.value}</div>div>
                                                                          <div className="text-xs font-medium text-gray-400 mt-0.5">{kpi.label}</div>div>
                                                                          <div className="text-[10px] text-gray-600 mt-0.5">{kpi.sub}</div>div>
                                                        </div>div>
                                        </div>div>
                                      );
          })}
                          ...
                          {/* BU cards */}
                                  <div className="xl:col-span-2 space-y-3">
                                              <div className="flex items-center justify-between mb-1">
                                                            <h2 className="text-sm font-semibold text-white">Business Units</h2>h2>
                                            ...
                                            <Link
                                                              ...
                                                              <div className="flex-1 min-w-0">
                                                                                  <div className="flex items-center gap-2">
                                                                                                        <span className="text-sm font-bold text-white">{bu.label}</span>span>
                                                                                                        <span className={`badge ${bu.statusColor}`}>{bu.status}</span>span>
                                                                                    </div>div>
                                                                                  <div className="text-xs text-gray-500 mt-0.5">{bu.sub}</div>div>
                                                              </div>div>
                                                              <div className="hidden sm:flex items-center gap-4 mr-2">
                                                                {bu.kpis.map((kpi) => (
                                                                                      <div key={kpi.label} className="text-center">
                                                                                                              <div className="text-sm font-bold text-white">{kpi.value}</div>div>
                                                                                                              <div className="text-[10px] text-gray-600">{kpi.label}</div>div>
                                                                                        </div>div>
                                                                                    ))}
                                                              </div>div>
                          ...
                          {/* Activity */}
                                  <div className="card p-5">
                                              <div className="flex items-center gap-2 mb-4">
                                                            ...
                                                            <h2 className="text-sm font-semibold text-white">Atividade do Grupo</h2>h2>
                                              </div>div>
                            ...
                            <div key={i} className="flex items-start gap-3">
                                              <div
                                                                  ...
                                                                  />
                                              <div>
                                                                  <div className="text-xs text-gray-300">{item.label}</div>div>
                                                                  <div className="text-[10px] text-gray-600 mt-0.5">{item.time}</div>div>
                                              </div>div>
                            </div>div>
                          ))}
                                              </div>div>
                  ...
                  {/* Financial quick access */}
                        <Link
                                  ...
                                  <div className="flex-1 min-w-0">
                                              <div className="text-sm font-bold text-white">Financial</div>div>
                                              <div className="text-xs text-gray-500 mt-0.5">Receita, margem e canais de aquisição</div>div>
                                  </div>div>
                                  <div className="hidden sm:flex items-center gap-6 mr-2">
                                    ...
                                    { label: "Margem Média", value: "67.4%" },
                                                                ...
                                                                <div key={s.label} className="text-center">
                                                                                <div className="text-sm font-bold text-white">{s.value}</div>div>
                                                                                <div className="text-[10px] text-gray-600">{s.label}</div>div>
                                                                </div>div>
                                                              ))}
                                  </div>div>
