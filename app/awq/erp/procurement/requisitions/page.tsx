...
type ReqStatus = "Aberta" | "Em Aprovação" | "Aprovada" | "Recusada";
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-lg px-3 py-2 max-w-sm shadow-sm">
          ...
          <input
            ...
            placeholder="Buscar requisição ou solicitante…"
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-100">
              <thead className="bg-gray-50">
                <tr>
                  {["Nº Req.", "Solicitante", "Item / Serviço", "Quantidade", "Data Necessidade", "Status"].map((h) => (
        ...
        <div className="flex flex-wrap gap-2">
          {(Object.entries(STATUS_BADGE) as [ReqStatus, string][]).map(([status, cls]) => (
