          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-100">
              <thead className="bg-gray-50">
                <tr>
                  {["Asset", "Motivo", "Data Baixa", "Valor Contábil", "Valor de Venda", "Resultado", "Responsável"].map((h) => (
