      ...
      <div className="page-container">
        ...
        <div className="card p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <Link href="/allocations" className="ml-auto text-[11px] text-brand-600 hover:text-brand-500 flex items-center gap-1 transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            { label: "Financial",   href: "/financial",   icon: DollarSign, color: "text-emerald-600", bg: "bg-emerald-50" },
            { label: "Allocations", href: "/allocations", icon: Wallet,     color: "text-amber-700",   bg: "bg-amber-50"   },
            { label: "KPIs",        href: "/kpis",         icon: BarChart3,  color: "text-violet-700",  bg: "bg-violet-50"  },
            { label: "Control Tower",href: "/",             icon: Building2,  color: "text-brand-600",   bg: "bg-brand-50"   },
          ].map((item) => {
