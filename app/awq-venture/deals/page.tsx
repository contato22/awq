...
import { loadCustomDeals, loadCustomDealsFromDB } from "./custom-deal-utils";
import {
  TrendingUp,
  DollarSign,
  CheckCircle2,
...
export default function DealsIndexPage() {
  ...
  useEffect(() => {
    setCustomDeals(loadCustomDeals()); // immediate from localStorage
    loadCustomDealsFromDB().then(setCustomDeals).catch(() => {}); // update from DB
  }, []);
