        ...
        <div className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
          <div className="flex flex-wrap items-center gap-4 text-[10px] text-gray-500">
            ...
            <span className="ml-auto flex items-center gap-1">
              <ArrowRight size={10} />
              <Link href="/conciliacao" className="underline hover:text-gray-700">Ingestao</Link>
              <span className="mx-1">·</span>
              <Link href="/financial" className="underline hover:text-gray-700">Financial</Link>
              <span className="mx-1">·</span>
              <Link href="/investments" className="underline hover:text-gray-700">Investimentos</Link>
            </span>
          </div>
        </div>
