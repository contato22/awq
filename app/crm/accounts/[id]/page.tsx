...
import {
  Building2, Users, Target, Activity, Globe, Linkedin,
...
export default function AccountDetailPage() {
  ...
  if (!account) return (
    <>
      ...
      <div className="page-container">
        <EmptyState title="Conta não encontrada" description="Verifique o ID e tente novamente." action={<Link href="/crm/accounts" className="text-brand-600 text-sm font-medium">← Voltar para Contas</Link>} />
      </div>
    </>
  );
