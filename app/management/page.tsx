    ...
    <div className="min-h-screen bg-gray-50 px-6 py-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-3 mt-4 flex-wrap">
          <Link href="/conciliacao" className="text-xs px-3 py-1.5 bg-brand-50 border border-brand-200 text-brand-700 rounded-lg hover:bg-brand-100 transition-colors font-medium">
            → Ingestão
          </Link>
          <Link href="/data" className="text-xs px-3 py-1.5 bg-gray-100 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-200 transition-colors font-medium">
            → Base de Dados
          </Link>
          <Link href="/kpis" className="text-xs px-3 py-1.5 bg-gray-100 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-200 transition-colors font-medium">
            → KPIs
          </Link>
        </div>
      </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                {covered ? (
                  ...
                  <div className="text-[10px] text-amber-700 font-medium">
                    ...
                    <Link href="/conciliacao" className="underline">ingerir agora</Link>
        ...
        <div className="mb-6 flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl p-4">
          ...
          <div>
            ...
            <div className="text-xs text-red-600 mt-0.5">
              ...
              <Link href="/conciliacao" className="underline font-medium">/awq/conciliacao</Link>{" "}
        ...
        {!diag.hasRealData && (
          <div className="mt-4 pt-4 border-t border-gray-100">
            <div className="text-xs text-gray-500">
              ...
              <Link href="/conciliacao" className="text-brand-600 underline font-medium">/awq/conciliacao</Link>
