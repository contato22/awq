...
export const PLATFORM_ROUTES: PlatformRoute[] = [
  ...
  { href: "/awq/risk",         label: "Risk",           bu: "awq",  layer: "control-tower", status: "active", dataSource: "lib/financial-metric-query.ts → getAWQGroupKPIs() + getEntityCashMetrics() (real) + snapshot (risk signals)", inSidebar: true,  inTabNav: false },
  ...
  { href: "/jacqes/financial",        label: "Financial",      bu: "jacqes", layer: "bu-financial",  status: "consolidated", dataSource: "lib/financial-query.ts + lib/data.ts",            inSidebar: false, inTabNav: false, canonical: "/jacqes/fpa" },
  { href: "/jacqes/revenue",          label: "Revenue",        bu: "jacqes", layer: "bu-financial",  status: "consolidated", dataSource: "lib/data.ts",            inSidebar: false, inTabNav: false, canonical: "/jacqes/fpa" },
  { href: "/jacqes/customers",        label: "Customers",      bu: "jacqes", layer: "bu-operations", status: "consolidated", dataSource: "lib/data.ts",            inSidebar: false, inTabNav: false, canonical: "/jacqes/fpa" },
  { href: "/jacqes/unit-economics",   label: "Unit Economics", bu: "jacqes", layer: "bu-operations", status: "consolidated", dataSource: "lib/data.ts",            inSidebar: false, inTabNav: false, canonical: "/jacqes/fpa" },
  { href: "/jacqes/budget",           label: "Budget",         bu: "jacqes", layer: "bu-financial",  status: "consolidated", dataSource: "lib/data.ts",            inSidebar: false, inTabNav: false, canonical: "/jacqes/fpa" },
