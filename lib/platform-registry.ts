...
export const PLATFORM_ROUTES: PlatformRoute[] = [
  ...
  { href: "/awq/novidades",   label: "Novidades",      bu: "awq", layer: "control-tower", status: "active", dataSource: "static (changelog inline — histórico de atualizações da plataforma)", inSidebar: true,  inTabNav: false },
  ...
  { href: "/awq/data/storage",  label: "Storage",       bu: "awq", layer: "data-infra", status: "active",   dataSource: "lib/db.ts (USE_DB, USE_BLOB) + lib/financial-db.ts + lib/financial-ingest-status.ts (adaptadores Neon/Blob/JSON)", inSidebar: false, inTabNav: false },
