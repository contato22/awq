...
export const PLATFORM_ROUTES: PlatformRoute[] = [
  ...
  { href: "/awq/forecast",  label: "Forecast",        bu: "awq", layer: "corporate-fpa", status: "active", dataSource: "lib/awq-derived-metrics.ts → awq-group-data.ts (revenueForecasts, forecastAccuracyHistory, buForecastScenarios) — 100% snapshot accrual planejamento. Real pipeline: buildFinancialQuery() consultado apenas para status; sem dados reais até extrato ingerido. AUDITADO 2026-04-15: nenhum dado real nesta página.", inSidebar: true, inTabNav: false },
