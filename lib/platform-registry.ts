...
export const PLATFORM_ROUTES: PlatformRoute[] = [
  ...
  { href: "/awq/ap-ar",       label: "AP & AR",       bu: "awq", layer: "corporate-treasury", status: "active", dataSource: "IndexedDB awq-treasury/ap_ar_items (lib/ap-ar-repo.ts — persistido no browser via IndexedDB)", inSidebar: true, inTabNav: false },
