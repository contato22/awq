...
export const SEED_TASKS: PpmTask[] = [
  ...
  { task_id:"tsk-001", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", task_name:"Pré-Produção", task_type:"phase", wbs_code:"1", sort_order:1, estimated_hours:40, actual_hours:40, start_date:"2026-01-15", due_date:"2026-01-31", completed_date:"2026-01-31", status:"completed", completion_pct:100, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-01-31T18:00:00Z" },
  { task_id:"tsk-002", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-001", task_name:"Briefing com cliente", task_type:"task", wbs_code:"1.1", sort_order:2, assigned_to:"miguel", assigned_name:"Miguel", estimated_hours:4, actual_hours:4, start_date:"2026-01-15", due_date:"2026-01-16", completed_date:"2026-01-16", status:"completed", completion_pct:100, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-01-16T18:00:00Z" },
  { task_id:"tsk-003", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-001", task_name:"Desenvolvimento de roteiro", task_type:"task", wbs_code:"1.2", sort_order:3, assigned_to:"miguel", assigned_name:"Miguel", estimated_hours:16, actual_hours:16, start_date:"2026-01-17", due_date:"2026-01-24", completed_date:"2026-01-24", status:"completed", completion_pct:100, is_deliverable:true, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-01-24T18:00:00Z" },
  { task_id:"tsk-004", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-001", task_name:"Casting e locação", task_type:"task", wbs_code:"1.3", sort_order:4, assigned_to:"danilo", assigned_name:"Danilo", estimated_hours:12, actual_hours:12, start_date:"2026-01-25", due_date:"2026-01-30", completed_date:"2026-01-30", status:"completed", completion_pct:100, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-01-30T18:00:00Z" },
  { task_id:"tsk-005", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", task_name:"Produção", task_type:"phase", wbs_code:"2", sort_order:5, estimated_hours:120, actual_hours:88, start_date:"2026-02-01", due_date:"2026-02-28", status:"in_progress", completion_pct:73, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-04-28T10:00:00Z" },
  { task_id:"tsk-006", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-005", task_name:"Filmagem — Vídeo 1", task_type:"task", wbs_code:"2.1", sort_order:6, estimated_hours:24, actual_hours:24, start_date:"2026-02-03", due_date:"2026-02-04", completed_date:"2026-02-04", status:"completed", completion_pct:100, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-02-04T18:00:00Z" },
  { task_id:"tsk-007", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-005", task_name:"Filmagem — Vídeo 2", task_type:"task", wbs_code:"2.2", sort_order:7, estimated_hours:24, actual_hours:24, start_date:"2026-02-10", due_date:"2026-02-11", completed_date:"2026-02-11", status:"completed", completion_pct:100, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-02-11T18:00:00Z" },
  { task_id:"tsk-008", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-005", task_name:"Filmagens restantes (3 vídeos)", task_type:"task", wbs_code:"2.3", sort_order:8, estimated_hours:72, actual_hours:40, start_date:"2026-02-15", due_date:"2026-02-28", status:"in_progress", completion_pct:55, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-04-20T10:00:00Z" },
  { task_id:"tsk-009", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", task_name:"Pós-Produção", task_type:"phase", wbs_code:"3", sort_order:9, estimated_hours:80, actual_hours:20, start_date:"2026-03-01", due_date:"2026-03-25", status:"in_progress", completion_pct:25, is_deliverable:false, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-04-28T10:00:00Z" },
  { task_id:"tsk-010", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-009", task_name:"Edição final", task_type:"task", wbs_code:"3.1", sort_order:10, estimated_hours:60, actual_hours:20, start_date:"2026-03-01", due_date:"2026-03-20", status:"in_progress", completion_pct:33, is_deliverable:true, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-04-28T10:00:00Z" },
  { task_id:"tsk-011", project_id:"prj-001", project_name:"XP Investimentos — Campanha Q1 2026", parent_task_id:"tsk-009", task_name:"Entrega e aprovação final", task_type:"milestone", wbs_code:"3.2", sort_order:11, estimated_hours:8, actual_hours:0, start_date:"2026-03-24", due_date:"2026-03-25", status:"not_started", completion_pct:0, is_deliverable:true, created_at:"2026-01-10T10:00:00Z", updated_at:"2026-01-10T10:00:00Z" },
  // Nubank (prj-002)
  { task_id:"tsk-020", project_id:"prj-002", project_name:"Nubank — Vídeo Institucional", task_name:"Briefing & Concept", task_type:"phase", wbs_code:"1", sort_order:1, estimated_hours:16, actual_hours:12, start_date:"2026-02-01", due_date:"2026-02-10", status:"in_progress", completion_pct:75, is_deliverable:false, created_at:"2026-01-28T10:00:00Z", updated_at:"2026-04-20T10:00:00Z" },
  { task_id:"tsk-021", project_id:"prj-002", project_name:"Nubank — Vídeo Institucional", task_name:"Produção", task_type:"phase", wbs_code:"2", sort_order:2, estimated_hours:40, actual_hours:12, start_date:"2026-02-11", due_date:"2026-02-28", status:"blocked", blocked_reason:"Briefing final não aprovado pelo cliente após 3 semanas", completion_pct:30, is_deliverable:false, created_at:"2026-01-28T10:00:00Z", updated_at:"2026-04-20T10:00:00Z" },
  { task_id:"tsk-022", project_id:"prj-002", project_name:"Nubank — Vídeo Institucional", task_name:"Pós-Produção e Entrega", task_type:"phase", wbs_code:"3", sort_order:3, estimated_hours:24, actual_hours:0, start_date:"2026-03-01", due_date:"2026-03-15", status:"not_started", completion_pct:0, is_deliverable:false, created_at:"2026-01-28T10:00:00Z", updated_at:"2026-01-28T10:00:00Z" },
  // Reabilicor (prj-004)
  { task_id:"tsk-030", project_id:"prj-004", project_name:"Reabilicor — Consultoria Estratégica", task_name:"Diagnóstico Estratégico", task_type:"phase", wbs_code:"1", sort_order:1, estimated_hours:40, actual_hours:40, start_date:"2026-03-01", due_date:"2026-03-31", completed_date:"2026-03-31", status:"completed", completion_pct:100, is_deliverable:true, created_at:"2026-02-20T10:00:00Z", updated_at:"2026-03-31T18:00:00Z" },
  { task_id:"tsk-031", project_id:"prj-004", project_name:"Reabilicor — Consultoria Estratégica", task_name:"Plano de Ação", task_type:"phase", wbs_code:"2", sort_order:2, estimated_hours:40, actual_hours:0, start_date:"2026-04-01", due_date:"2026-05-31", status:"not_started", completion_pct:0, is_deliverable:false, created_at:"2026-02-20T10:00:00Z", updated_at:"2026-02-20T10:00:00Z" },
  { task_id:"tsk-032", project_id:"prj-004", project_name:"Reabilicor — Consultoria Estratégica", task_name:"Implementação", task_type:"phase", wbs_code:"3", sort_order:3, estimated_hours:40, actual_hours:0, start_date:"2026-06-01", due_date:"2026-06-30", status:"not_started", completion_pct:0, is_deliverable:false, created_at:"2026-02-20T10:00:00Z", updated_at:"2026-02-20T10:00:00Z" },
];
