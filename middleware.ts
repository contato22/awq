...
export const config = {
  matcher: [
    "/((?!login|api/auth|api/health|api/debug/version|api/cora/audit-probe|api/cora/sync-probe|api/cora/cron-sync|api/setup/seed-santander-extracts|api/enrd/debug-saldo|_next/static|_next/image|favicon\\.ico).*)",
  ],
};
